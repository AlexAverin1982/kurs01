...
from src.datetime_utils import is_leap_year, get_date, get_period, get_report_span, get_span_dates, get_month_dates
...
@pytest.mark.parametrize(
    "end_date, expected_result",
    [(['2019-07-15 00:00:00'], (datetime(2019, 7, 1), datetime(2019, 7, 15)))])
