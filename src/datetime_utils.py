...
def get_date(format_string: str = '%d.%m.%Y',
             prompt: str = "Введите дату конца отчетного периода: ", show_format: bool = True) -> datetime:
...
def get_period(date_format: str = 'YYYY-MM-DD HH:MM:SS',
               prompt: str = "Введите дату конца отчетного периода: ") -> tuple[datetime, datetime]:
    """ Запрашиваем у пользователя дату из отчетного периода
