def show_main_page_menu() -> int:
    ...
    while True:
        ...
        print('2. Страница "События": статистика по расходам и доходам')
        print('3. Страница "Сервисы": инвесткопилка')
        print('4. Страница "Отчеты": Средние траты в рабочий/выходной день за 3 месяца')
        print('5. Принудительно обновить кэш цен на валюты и акции, используя API')
        print("9. Выход")
        user_input = input("\nВаш выбор: ")
...
def show_currencies_and_stocks_menu() -> int:
    """
    Меню выбора валют и акций пользователя
    :return:
    """
    while True:
